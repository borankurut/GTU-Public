...
public class TestClass1{
    public static void main(String[] args) {
        ...
        try {
            PrintStream fileStream = new PrintStream("LDLinkedListTestClass1Output.txt");
        ...
        loggedIn.like(likeId++, sibelgulmez.getPosts().get(0));

        System.out.println("\nStep 10... Adding a comment on a post of sibelgulmez...");
        loggedIn.comment(commentId, sibelgulmez.getPosts().get(0), "me too!");
        ...
        loggedIn.like(likeId++, sibelgulmez.getPosts().get(0));
        loggedIn.like(likeId++, sibelgulmez.getPosts().get(1));
