...
public class Account{
    ...
    private LDLinkedList<Account> blocked;
    ...
    public Account(int newId, String newUsername, int newBirthDay, int newBirthMonth, 
        ...
        messages = new LDLinkedList<Message>();

        following = new LDLinkedList<Account>();
        followers = new LDLinkedList<Account>();
        blocked = new LDLinkedList<Account>();

        actionHistory = new LDLinkedList<String>();
    ...
    public LDLinkedList<Account> getFollowers(){return followers;}
    public LDLinkedList<Account> getBlocked(){return blocked;}
