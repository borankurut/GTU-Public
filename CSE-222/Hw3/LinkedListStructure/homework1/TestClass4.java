...
public class TestClass4{
    public static void main(String[] args) {
        try {
            PrintStream fileStream = new PrintStream("LinkedListTestClass4Output.txt");
        ...
        for(int i = 1; i < 10; ++i){
            ...
            System.out.println("(account0's followers list:");
            System.out.println(accounts.get(0).getFollowers());
            System.out.println();
        }
