...
public class Account{
    ...
    private LinkedList<Account> blocked;
    ...
    public Account(int newId, String newUsername, int newBirthDay, int newBirthMonth, 
        ...
        blocked = new LinkedList<Account>();
    ...
    public LinkedList<Account> getFollowers(){return followers;}
    public LinkedList<Account> getBlocked(){return blocked;}
