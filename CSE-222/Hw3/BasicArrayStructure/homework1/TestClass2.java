...
public class TestClass2{
    public static void main(String[] args) {    
        try {
            PrintStream fileStream = new PrintStream("BasicArrayTestClass2Output.txt");
        ...
        System.out.println("\nb. likes Post1.");
        loggedIn.like(likeId++, gizemsungu.getPosts()[0]);
        ...
        loggedIn.comment(commentId++, gizemsungu.getPosts()[1], "Nice!");
