...
namespace myos
{
    namespace hardwarecommunication
    {
        ...
        protected:
            ...
            ~InterruptHandler();
			common::uint32_t ForkInt(CPUState* cpuState);
        public:
        ...
        class InterruptManager
        {
            ...
            public:
				...
				// these are added to debug schedular. schedular is called once every SCH_SLW_DWN interrupts
				// When it is not called, I made the DoHandleInterrupt sleep for very short amount of time.
				
				static common::uint32_t timerInterruptAmount;
				static const common::uint32_t SCH_SLW_DWN = 99;
        };
